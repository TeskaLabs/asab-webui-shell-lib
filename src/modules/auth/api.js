	...
	*/
	...
	async login(redirect_uri, force_login_prompt) {
		...
		*/
		...
		let loginScope = (currentTenant != null) && (tenantValue != undefined)
			? this.Scope.replace(`${tenantValue}`, `tenant:${currentTenant}`)
			: this.Scope;
		...
		*/
		...
		localStorage.setItem(`oauth2_state_${stateIndex}`, state);
